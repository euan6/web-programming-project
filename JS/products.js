...
window.addEventListener("load", function() {
    ...
    products[3].name, products[3].price, products[3].description);
    ...
    products[4].name, products[4].price, products[4].description);
    ...
    products[5].name, products[5].price, products[5].description);
    ...
    products[6].name, products[6].price, products[6].description);
    ...
    products[7].name, products[7].price, products[7].description);
    ...
    products[8].name, products[8].price, products[8].description);
    ...
    products[9].name, products[9].price, products[9].description);
});
